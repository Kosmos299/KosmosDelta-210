...
#define CUSTOM_MACHINE_NAME "Delta Kosmos"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "9622d12f-5cdd-4539-9b8c-c9098b03b038"
...
#define DELTA_AUTO_CALIBRATION  // G33 Delta Auto-Calibration (Enable EEPROM_SETTINGS to store results)

// NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
#define DELTA_CALIBRATION_DEFAULT_POINTS 4
#define PROBE_MANUALLY_STEP 0.05      // (mm) Set the steprate for papertest probing
...
#define DEFAULT_EJERK DEFAULT_XJERK  // May be used by Linear Advance
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //TODO: WTF, config change...

/**
 * Use the nozzle as the probe, as with a conductive
 * nozzle system or a piezo-electric smart effector.
 */
//#define NOZZLE_AS_PROBE //TODO: WTF, config change...
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -0.45 }      //accounts for bed elasticity

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 0

#define XY_PROBE_FEEDRATE (50*60)                   // X and Y axis travel speed (mm/min) between probes
#define Z_PROBE_FEEDRATE_FAST XY_PROBE_FEEDRATE     // Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_SLOW XY_PROBE_FEEDRATE     // Feedrate (mm/min) for the "accurate" probe of each point
...
#define X_BED_SIZE ((DELTA_MAX_RADIUS) * 2)
#define Y_BED_SIZE ((DELTA_MAX_RADIUS) * 2)

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -(DELTA_MAX_RADIUS)
#define Y_MIN_POS -(DELTA_MAX_RADIUS)
#define Z_MIN_POS -10 
#define X_MAX_POS DELTA_MAX_RADIUS
#define Y_MAX_POS DELTA_MAX_RADIUS
 ...
 */
//#define BD_SENSOR //TODO reverse engineer the shit out of it
...
//#define MESH_EDIT_GFX_OVERLAY   // Display a graphics overlay while editing the mesh //04.09.2022 DA: no LCD avalible for marlin
...
#define NOZZLE_PARK_XY_FEEDRATE   XY_PROBE_FEEDRATE   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
#define NOZZLE_PARK_Z_FEEDRATE    XY_PROBE_FEEDRATE   // (mm/s) Z axis feedrate (not used for delta printers)
