...
#define STRING_CONFIG_H_AUTHOR "(BTT + TFT3.5 - Custom Delta, D.Adamik 04.09.2022)"
...
#define Z_PROBE_FEEDRATE_FAST XY_PROBE_FEEDRATE0  // Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
